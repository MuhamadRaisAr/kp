        ...
        <div class="card-body">
            <form action="proses_ujian_edit.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="judul_ujian" value="<?= htmlspecialchars($ujian['judul_ujian']) ?>" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">Durasi (Menit)</label>
                    <input type="number" class="form-control" name="durasi_menit" value="<?= htmlspecialchars($ujian['durasi_menit']) ?>" required>
                </div>
